	...
	<div class="container">
		<div class="row">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="3" style="background-color: #eeeeee; text-align: center;">Contents</th>
						</tr>
					</thead>
					<tbody>
						<tr>
                        ...
                        <tr>
                            <td>Body</td>
                            <td colspan="2" style="min-height: 200px; text-align: legt;"><%= bbs.getBbsContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
                        </tr>
					</tbody>
				</table>
			    ...
			    %>
			            ...
			            <a onclick="return confirm('Do you want to Delete your content?')" href="deleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">Delete</a>
			    <%  
			        }
				%>
		</div>
